...
local UserName = (data.username_ or "dev_elblitsho")
...
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس البلياتشو\n ❃∫ الاصدار » { 6.7v}')
dofile('BOYKA.lua')  
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'dev_elblitsho')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'dev_elblitsho')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'dev_elblitsho')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/dev_elblitsho)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/dev_elblitsho)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
  ...
  ↬ .BOYKA TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/dev_elblitsho)  
  
  ↬ . [DEVELOPER](t.me/dev_elblitsho)       
   
  ↬ . [Information](t.me/dev_elblitsho) 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'dev_elblitsho')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'dev_elblitsho')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات البلياتشو\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘽𝙆━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘽𝙆━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس البلياتشو↓\n".." ❃∫ [اضغط هنا لدخول](t.me/elserk) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس البلياتشو \n") 
end
return false
end
...
local UserName = (b.username_ or "dev_elblitsho")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'dev_elblitsho')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'dev_elblitsho')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'dev_elblitsho')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'البلياتشو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'البلياتشو')
local BOYKA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'البلياتشو').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'dev_elblitsho')..')'
local iduser = result.sender_user_id_
...
return false
  ...
  local Text =[[
    ...
    *❃م10 ◂ اوامر الاعضاء*
    ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ
    彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/dev_elblitsho)➢ 
  ]]
  keyboard = {} 
  ...
  {
  {text = '𝐁𝐎𝐘𝐊𝐀 {𝐑} 𝐓𝐄𝐀𝐌', url="t.me/dev_elblitsho"},
  },
  }
...
if data.ID == "UpdateNewCallbackQuery" then
  ...
  local Teext =[[
    ...
    ⌯︙ تحا
    •━━━━━━━━━•ٴ
    彡 .[𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/dev_elblitsho)➢
  ]]
  keyboard = {} 
  keyboard.inline_keyboard = {
  {
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'البلياتشو')
